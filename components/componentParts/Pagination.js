  ...
  render(){
    ...
    if(currentPage > 1 && currentPage < noOfPages){
      ...
      <div className='nav-links text-center'>
        <Link to={parentPath+previous} className='page-numbers col-xs-4 col-sm-4 col-md-4 col-lg-4 btn btn-primary'>Previous</Link>
        ...
        <Link to={parentPath+next} className='page-numbers col-xs-4 col-sm-4 col-md-4 col-lg-4 btn btn-primary'>Next</Link>
      </div>
